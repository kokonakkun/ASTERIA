...
- 日本語、英語、簡体字中国語、繁体字中国語、韓国語、スペイン語、フランス語、ドイツ語、ブラジルポルトガル語、ヒンディー語、アラビア語の11言語パック
- OS言語の自動判定と、再起動不要の言語切替
- アラビア語向けRTLレイアウト
- 言語別の日付・数値フォーマット
- 公式サイトの言語セレクターと英語フォールバック

### Improved

- 動的に生成されるタスク、予定、診断、通知にも適用される共通翻訳エンジン
- Windows通知、トレイメニュー、バックアップ／交換ダイアログのローカライズ
- 言語名を常にネイティブ表記するアクセシブルな選択UI

### Privacy

- 翻訳資産はアプリ内に収録し、ユーザー入力を外部翻訳サービスへ送信しない設計

### Compatibility

- データスキーマ8
- 旧スキーマ1〜7を自動移行し、既存データと外観設定を保持

[4.5.0]: ../../releases/tag/v4.5.0
